...
std::shared_ptr<Frame> LocalOptimizer::getNewKeyframe()
{
...
void LocalOptimizer::matchFeatures(std::shared_ptr<Frame> kf)
{
...
void LocalOptimizer::createNewPoints(std::shared_ptr<Frame> kf)
{
...
void LocalOptimizer::detectLoop(std::shared_ptr<Frame> kf)
{
    Mat freePtDesc;
...
void LocalOptimizer::setViewer(MapViewer *viewer)
{
    this->viewer = viewer;
}
