...
__host__ __device__ __forceinline__ void multAB(float a11, float a12, float a13,
...
__host__ __device__ __forceinline__ void multAtB(float a11, float a12, float a13,
                                                 float a21, float a22, float a23,
                                                 float a31, float a32, float a33,
                                                 //
                                                 float b11, float b12, float b13,
...
__host__ __device__ __forceinline__ void jacobiConjugation(const int x, const int y, const int z,
                                                           float &s11,
                                                           float &s21, float &s22,
...
/// A = UP
__host__ __device__ __forceinline__ void pd(float a11, float a12, float a13,
                                            float a21, float a22, float a23,
                                            float a31, float a32, float a33,
                                            // output U
                                            float &u11, float &u12, float &u13,
